Attribute VB_Name = "m_javautilAbstractMap"
'Generated by IDL2VB v121. Copyright (c) 2000-2003 Martin.Both
'Source File Name: jdk1.4/idl/java/util/AbstractMap.idl

Option Explicit

'valuetype ::java::util::AbstractMap
Public Const TypeId As String = "IDL:java/util/AbstractMap:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ValueTc("AbstractMap", iTypeModifier, oConcreteBase, oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
