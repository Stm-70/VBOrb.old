...
'interface ::DB::Cursor
Public Const TypeId As String = "IDL:DB/Cursor:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As c_DBCursor
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As c_DBCursor
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
