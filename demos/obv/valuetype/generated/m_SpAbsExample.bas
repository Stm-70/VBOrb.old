Attribute VB_Name = "m_SpAbsExample"
'Generated by IDL2VB v121. Copyright (c) 2000-2003 Martin.Both
'Source File Name: ../demos/obv/valuetype/valuetype.idl

Option Explicit

'interface ::obv::support_abstract::Example
Public Const TypeId As String = "IDL:obv/support_abstract/Example:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As c_SpAbsExample
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New c_SpAbsExample
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As c_SpAbsExample
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
