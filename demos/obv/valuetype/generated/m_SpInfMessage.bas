Attribute VB_Name = "m_SpInfMessage"
'Generated by IDL2VB v121. Copyright (c) 2000-2003 Martin.Both
'Source File Name: ../demos/obv/valuetype/valuetype.idl

Option Explicit

'interface ::obv::support_interface::Message
Public Const TypeId As String = "IDL:obv/support_interface/Message:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As c_SpInfMessage
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
        Set narrow = Nothing
    Else
        Dim oObj As cOrbObject
        Set oObj = New c_SpInfMessage
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As c_SpInfMessage
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
