Attribute VB_Name = "m_ServerCounter"
...
Public Const TypeId As String = "IDL:Server/Counter:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As c_ServerCounter
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As c_ServerCounter
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
