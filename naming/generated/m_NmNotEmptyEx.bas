Attribute VB_Name = "m_NmNotEmptyEx"
...
Public Const TypeId As String = "IDL:omg.org/CosNaming/NamingContext/NotEmpty:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("NotEmpty", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As c_NmNotEmptyEx
    Dim oException As c_NmNotEmptyEx
    Set oException = New c_NmNotEmptyEx
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As c_NmNotEmptyEx) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
