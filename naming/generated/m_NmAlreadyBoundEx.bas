Attribute VB_Name = "m_NmAlreadyBoundEx"
...
Public Const TypeId As String = "IDL:omg.org/CosNaming/NamingContext/AlreadyBound:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("AlreadyBound", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As c_NmAlreadyBoundEx
    Dim oException As c_NmAlreadyBoundEx
    Set oException = New c_NmAlreadyBoundEx
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As c_NmAlreadyBoundEx) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
