...
'interface ::CORBA::ORB
Public Const TypeId As String = "IDL:omg.org/CORBA/ORB:1.0"

'Helper
Public Function narrow(ByVal Obj As cOrbObject) As c_SunORB
...
'Helper
Public Function uncheckedNarrow(ByVal Obj As cOrbObject) As c_SunORB
    On Error GoTo ErrHandler
    If Obj Is Nothing Then
