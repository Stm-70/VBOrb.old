Attribute VB_Name = "m_NmCannotProceedEx"
...
Public Const TypeId As String = "IDL:omg.org/CosNaming/NamingContext/CannotProceed:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        oMemSeq.Item(0).name = "cxt"
        Set oMemSeq.Item(0).p_type = oOrb.createInterfaceTc("IDL:omg.org/CosNaming/NamingContext:1.0", "NamingContext")
        ...
        Call oRecTC.setRecTc2ExceptionTc("CannotProceed", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As c_NmCannotProceedEx
    Dim oException As c_NmCannotProceedEx
    Set oException = New c_NmCannotProceedEx
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As c_NmCannotProceedEx) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
