Attribute VB_Name = "m_NmInvalidAddressEx"
...
Public Const TypeId As String = "IDL:omg.org/CosNaming/NamingContextExt/InvalidAddress:1.0"
...
Public Function TypeCode() As cOrbTypeCode
    ...
    If oRecTC Is Nothing Then
        ...
        Call oRecTC.setRecTc2ExceptionTc("InvalidAddress", oMemSeq)
    End If
    Set TypeCode = oRecTC
    Exit Function
ErrRollback:
...
Public Function extractFromAny(ByVal oAny As cOrbAny) As c_NmInvalidAddressEx
    Dim oException As c_NmInvalidAddressEx
    Set oException = New c_NmInvalidAddressEx
    Call oException.initByAny(oAny)
    Set extractFromAny = oException
End Function

'Helper, exception.writeMe() -> oAny.initByReadValue()
Public Function cloneAsAny(ByVal oException As c_NmInvalidAddressEx) As cOrbAny
    On Error GoTo ErrHandler
    Dim oAny As cOrbAny
